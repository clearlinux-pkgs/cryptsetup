...
Version  : 2.7.4
Release  : 88
URL      : https://mirrors.kernel.org/pub/linux/utils/cryptsetup/v2.7/cryptsetup-2.7.4.tar.gz
Source0  : https://mirrors.kernel.org/pub/linux/utils/cryptsetup/v2.7/cryptsetup-2.7.4.tar.gz
...
%prep
%setup -q -n cryptsetup-2.7.4
cd %{_builddir}/cryptsetup-2.7.4
pushd ..
cp -a cryptsetup-2.7.4 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1722451469
...
%files lib
%defattr(-,root,root,-)
/V3/usr/lib64/libcryptsetup.so.12.10.0
